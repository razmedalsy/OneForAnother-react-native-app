      ...
      auth()
        ...
        .then(() => {
          firestore()
            ...
            .then(resp => {
              if (resp.exists) {
                const {Name, userType, Category, Phone, imageURL} = resp.data();
                console.log('category resp: ', imageURL);
                if (userType === 'volunteer') {
                  ...
                  alert('No volunteer with this email exist');
                }
              } else {
                alert('No volunteer with this email exist');
              }
    ...
    <KeyboardAvoidingScrollView behavior="position">
      <View style={Styles.container}>
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('VolunteerForgotPassword')}>
